...
import {Form, Container, Button, TextArea, Segment, Menu, Select, Divider, Header, Input, Loader} from 'semantic-ui-react';
...
class EditArticleComponent extends React.Component {
    ...
    render(){
        const {currentArticle, topicsOptions, form, isLoading} = this.props.editArticleStore;
        return(
            <Container>
